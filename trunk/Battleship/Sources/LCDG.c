...
/*void setGridPixel(unsigned char grid[8][61], int row, int col, int x, int y) {
...
void LCD_DrawGrid(unsigned char field[10][10]) { 
  ...
  for(i=0; i<10; i++) {
    for(j=0; j<10; j++) {
      switch(field[i][j]) {
        case SHIPEND_UP:
          setGridPixel(grid, i, j, 2, 3);
          setGridPixel(grid, i, j, 3, 2);
          setGridPixel(grid, i, j, 3, 3);
          setGridPixel(grid, i, j, 3, 4);
          setGridPixel(grid, i, j, 4, 2);
          setGridPixel(grid, i, j, 4, 3);
          setGridPixel(grid, i, j, 4, 4);
          setGridPixel(grid, i, j, 5, 2);
          setGridPixel(grid, i, j, 5, 3);
          setGridPixel(grid, i, j, 5, 4);
          break;
        case SHIPEND_DOWN: 
          setGridPixel(grid, i, j, 1, 2);
          setGridPixel(grid, i, j, 1, 3);
          setGridPixel(grid, i, j, 1, 4);
          setGridPixel(grid, i, j, 2, 2);
          setGridPixel(grid, i, j, 2, 3);
          setGridPixel(grid, i, j, 2, 4);
          setGridPixel(grid, i, j, 3, 2);
          setGridPixel(grid, i, j, 3, 3);
          setGridPixel(grid, i, j, 3, 4);
          setGridPixel(grid, i, j, 4, 3);
        ...
        case SHIPEND_LEFT: 
          setGridPixel(grid, i, j, 2, 3);
          setGridPixel(grid, i, j, 2, 4);
          setGridPixel(grid, i, j, 2, 5);
          setGridPixel(grid, i, j, 3, 2);
          setGridPixel(grid, i, j, 3, 3);
          setGridPixel(grid, i, j, 3, 4);
          setGridPixel(grid, i, j, 3, 5);
          setGridPixel(grid, i, j, 4, 3);
          setGridPixel(grid, i, j, 4, 4);
          setGridPixel(grid, i, j, 4, 5);
          break;
        case SHIPEND_RIGHT:
          setGridPixel(grid, i, j, 2, 1);
          setGridPixel(grid, i, j, 2, 2);
          setGridPixel(grid, i, j, 2, 3);
          setGridPixel(grid, i, j, 3, 1);
          setGridPixel(grid, i, j, 3, 2);
          setGridPixel(grid, i, j, 3, 3);
          setGridPixel(grid, i, j, 3, 4);
          setGridPixel(grid, i, j, 4, 1);
          setGridPixel(grid, i, j, 4, 2);
          setGridPixel(grid, i, j, 4, 3);
          break;
        case SHIP_VERT:
        ...
        case HIT:  
          ...
          break;
        case MISS:
          setGridPixel(grid, i, j, 1, 1);
          setGridPixel(grid, i, j, 1, 5);
          setGridPixel(grid, i, j, 2, 2);
          setGridPixel(grid, i, j, 2, 4);
          setGridPixel(grid, i, j, 3, 3);
          setGridPixel(grid, i, j, 4, 2);
          setGridPixel(grid, i, j, 4, 4);
          setGridPixel(grid, i, j, 5, 1);
          setGridPixel(grid, i, j, 5, 5);
          break;
        default:
          //PTP |= 0x80;
          break;
